...
def test_short_token_appends_suffix():
    assert short_token("example-game-tor-bos-2026-06-18") == "example-game-tor-bos-2026-06-18::short"


def test_parse_long_token():
    slug, is_short = parse_token("example-game-tor-bos-2026-06-18")
    assert slug == "example-game-tor-bos-2026-06-18"
    assert is_short is False


def test_parse_short_token():
    slug, is_short = parse_token("example-game-tor-bos-2026-06-18::short")
    assert slug == "example-game-tor-bos-2026-06-18"
